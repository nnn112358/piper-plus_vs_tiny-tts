...
# Ensure the package root (tiny-tts/) is importable when this module is run
# from inside the infer/ directory or as a standalone script.
...
class OnnxTinyTTS:
    ...
    def __init__(self, onnx_dir: str = None, use_gpu: bool = False):
        if onnx_dir is None:
